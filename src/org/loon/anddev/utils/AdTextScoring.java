...
public class AdTextScoring extends ChangeableText {
	...
	public AdTextScoring(final float pX, final float pY, final Font pFont, final HorizontalAlign pHorizontalAlign, final int pInitialValue) {
		this(pX, pY, pFont, pHorizontalAlign, pInitialValue, null);
	}
	
	public AdTextScoring(final float pX, final float pY, final Font pFont, final HorizontalAlign pHorizontalAlign, final int pInitialValue, final String pLabel) {
