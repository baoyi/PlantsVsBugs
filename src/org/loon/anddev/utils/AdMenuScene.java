...
public abstract class AdMenuScene extends MenuScene implements IAdMenuScene, IOnMenuItemClickListener {
	
	protected float mTransparency = 0.65f;
	
	public AdMenuScene() {
		super(AdEnviroment.getInstance().getEngine().getCamera());		
	...
	public void closeMenuScene() {
		AdScene scene = (AdScene) AdEnviroment.getInstance().getScene();
