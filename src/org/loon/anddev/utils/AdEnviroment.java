...
public class AdEnviroment {
	
	private static AdEnviroment mInstance = null;
	...
	public static synchronized AdEnviroment getInstance() {
		if (mInstance == null)
			mInstance = new AdEnviroment();
		return mInstance;
	}
	...
	public void nextScene() {
		((AdFadeLayer) getScene().getChild(AdScene.FADE_LAYER)).fadeIn();
	}
