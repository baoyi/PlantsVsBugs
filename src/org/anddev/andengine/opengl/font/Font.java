...
public class Font {
	...
	protected static final float LETTER_LEFT_OFFSET = 2f;
	protected static final int LETTER_WIDTH_OFFSET = 4;
	...
	public int getStringWidth(final String pText) {
		...
		return this.mGetStringWidthTemporaryRect.width() + LETTER_WIDTH_OFFSET;
	}
