...
public abstract class BaseMenuItemDecorator implements IMenuItem {
	...
	@Override
	public void insertChild(final int index, final IEntity pEntity) {
		this.mMenuItem.insertChild(index, pEntity);
	}

	@Override
	public void updateChild(final int index, final IEntity pEntity) {
		this.mMenuItem.updateChild(index, pEntity);
	}
